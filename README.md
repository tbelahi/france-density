Little project for quick and dirty mapping of the population density of France used as a proxy for a comparison between matplotlib [colormaps](http://matplotlib.org/users/colormaps.html).
